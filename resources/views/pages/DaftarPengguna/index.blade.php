                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center" id="ch">
                            <h4 class="card-title">Data Daftar Pengguna</h4>
                            ...
                            <a class="btn btn-primary ml-auto btn-sm" href="{{ route('DaftarPengguna.create') }}">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="DaftarPengguna" class="display table table-hover">
                                <thead>
                                    <tr>
                                        <th>NIP</th>
                                        <th>Nama Pengguna</th>
                                ...
                                <tbody>
                                    @foreach ($DaftarPengguna as $p)
                                        <tr style="white-space:nowrap; width:1%;">
                                            ...
                                            <td>
                                                <a href="{{ route('DaftarPengguna.edit', $p->id) }}" type="button"
        ...
        $(document).ready(function() {
            $('#DaftarPengguna').DataTable({
                ...
                initComplete: (settings, json) => {
                    $('#DaftarPengguna_filter').appendTo('#search');
                },
            });
        });
    </script>
