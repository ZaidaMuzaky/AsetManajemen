        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('monitoring.store', $detailAset->id) }}" id="myForm">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-lg-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control" required>{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong class="text-capitalize">{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_monitoring" value="{{ old('tgl_monitoring') }}"
