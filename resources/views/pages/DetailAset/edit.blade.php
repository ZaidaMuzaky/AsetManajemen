            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Edit Data Aset</div>
                    </div>
                    <form method="POST" action="{{ route('detail-aset.update', $detailAset->id) }}" id="myForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('kode_aset') ?? $detailAset->kode_aset }}"
                                            name="kode_aset"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kategori_aset"
                                            value="{{ old('kategori_aset') ?? $detailAset->kategori_aset }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="asal_perusahaan"
                                            value="{{ old('asal_perusahaan') ?? $detailAset->asal_perusahaan }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lokasi"
                                            value="{{ old('lokasi') ?? $detailAset->lokasi }}"
                                        ...
                                        <select name="idPenanggungJawab" class="form-control form-control" required>
                                            ...
                                            @foreach ($pj as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == $detailAset->idPenanggungJawab ? 'selected' : '' }}>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="idDetailBarang" class="form-control form-control" required>
                                            ...
                                            @foreach ($dataBarang as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == $detailAset->idDetailBarang ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" value="{{ old('nama') ?? $detailAset->nama }}"
                                        ...
                                        <select name="kondisi" id="kondisi" class="form-control" required>
                                            ...
                                            @foreach ($status as $item)
                                                <option value="{{ $item->value }}"
                                                    {{ $detailAset->kondisi == $item->value ? 'selected' : '' }}>
                                                    {{ $item->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('kondisi')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi_aset" id="deskripsi_aset" cols="30" rows="10" class="form-control" required>{{ old('deskripsi_aset') ?? $detailAset->deskripsi_aset }}</textarea>
