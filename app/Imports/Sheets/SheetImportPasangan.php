...
class SheetImportPasangan extends DefaultValueBinder implements ToCollection, WithHeadingRow, WithCustomValueBinder
{
        ...
        foreach ($rows as  $row) {
            ...
            if ($keluarga) {
                DataPasangan::create([
                    ...
                    'nama_lengkap' => ucwords($row['Nama Pasangan']),
